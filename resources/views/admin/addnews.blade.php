...
@section('admin.addnews')
<div class="card">
            <div class="card-body">
              <h5 class="card-title">Add News</h5>

              <!-- Vertical Form -->
              <form class="row g-3" action="{{url('admin/storenews')}}" method="post" enctype="multipart/form-data">

              @csrf
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">News Title</label>
                  <input type="text" class="form-control" id="inputNanme4" name="title" placeholder="Enter News Title">
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <input type="file" class="form-control" id="inputAddress" name="image" required >
                </div>
                <div class="card">
            <div class="card-body">
