        ...
        <div class="container">
          ...
          <div class="row justify-content-center">
           ...
           <div class="pt-4 pb-2">
                    ...
                    <h5 class="card-title text-center pb-0 fs-4">Create new credentials</h5>
                    <p class="text-center small">Enter new username & password</p>
                  </div>
                 

                  <form class="row g-3 needs-validation" action="{{url('admin/credential')}}" method="post" novalidate>
@csrf
                    <div class="col-12">
